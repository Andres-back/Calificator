...
class Presentacion(Base):
    ...
    estado: Mapped[str] = mapped_column(String(40), nullable=False, default=PresentacionEstado.QUEUED.value)
    ...
    presenton_id: Mapped[str | None] = mapped_column(Text, nullable=True)

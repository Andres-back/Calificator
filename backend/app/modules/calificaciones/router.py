...
from app.modules.calificaciones import breakdown_service, evidence_service, photo_service, service
...
from app.services.evidence_bundle_service import EvidenceBundleError, build_evidence_bundle
...
MAX_EVIDENCE_PAGES = evidence_service.MAX_EVIDENCE_PAGES

# Compatibilidad progresiva para consumidores internos durante esta extracción.
EvidencePageError = evidence_service.EvidencePageError
_render_cached_evidence_page = evidence_service._render_cached_evidence_page
_parse_evidence_rotations = evidence_service._parse_evidence_rotations
_evidence_bundle_metadata = evidence_service._evidence_bundle_metadata
_delete_replaced_evidence = evidence_service._delete_replaced_evidence
_evidence_url = evidence_service._evidence_url
_entrega_read = evidence_service._entrega_read
_mixed_evidence_metadata = evidence_service._mixed_evidence_metadata

...
DEFAULT_PROVIDERS: list[dict[str, Any]] = [
    ...
    {
        "id": "ollama", "tipo": "texto", "label": "Ollama Cloud",
        "base_url": settings.OLLAMA_CLOUD_BASE_URL,
        "model": settings.OLLAMA_MODEL,
        "active": bool(settings.OLLAMA_API_KEY), "priority": 3,
        "timeout_seconds": settings.OLLAMA_TIMEOUT_SECONDS,
        "max_retries": 1, "allow_teacher_credentials": True,
    },
    {
...
DEFAULT_MODELS: list[dict[str, Any]] = [
    ...
    {"provider_id": "ollama", "model_id": settings.OLLAMA_MODEL, "label": settings.OLLAMA_MODEL, "capabilities": ["text"], "recommended": False, "active": False},

...
def generate_presentation(self, presentacion_id: str) -> dict:
    logger.info("Presentation generation started by Celery", extra={"presentation_id": presentacion_id})
    try:
        ...
        logger.exception("Presentation generation failed in Celery", extra={"presentation_id": presentacion_id})
        return {"status": "failed", "presentacion_id": presentacion_id, "error": str(exc)[:500]}

    logger.info("Presentation generation finished by Celery", extra={"presentation_id": presentacion_id})

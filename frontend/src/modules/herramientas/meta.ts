...
export const TOOLS: ToolMeta[] = [
  ...
  },
  {
    ...
    category: 'Material',
    description: 'Guía estructurada con objetivos, secciones y actividades.',
    icon: BookOpen,
  ...
  },
  {
    ...
    label: 'Taller',
    category: 'Material',
    description: 'Taller práctico con puntos y espacio para responder.',
    icon: ClipboardList,
  ...
  },
  {
    ...
    category: 'Material',
    description: 'Plan personalizado para reforzar a un estudiante.',
    icon: HeartHandshake,
  ...
  },
  {
    ...
    category: 'Material',
    description: 'Texto breve seguido de preguntas de comprensión, inferencia y vocabulario.',
    icon: BookMarked,

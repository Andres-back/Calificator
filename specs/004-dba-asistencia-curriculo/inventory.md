...
| endpoint | `GET:/materias/{materia_id}/asistencia` | authenticated | covered | `backend/app/modules/asistencia/router.py:17` |
| endpoint | `GET:/materias/{materia_id}/asistencia/reporte` | authenticated | covered | `backend/app/modules/asistencia/router.py:28` |
| endpoint | `GET:/materias/{materia_id}/dba` | authenticated | missing | `backend/app/modules/dba/router.py:131` |
...
| endpoint | `PUT:/materias/{materia_id}/asistencia` | authenticated | covered | `backend/app/modules/asistencia/router.py:40` |
...
- **low · missing_coverage**: 6 superficies de 004-dba-asistencia-curriculo no tienen evidencia de prueba observable.
- **medium · authorization_mismatch**: Permisos observables distintos para PUT:/materias/{}/asistencia: backend=['authenticated'], frontend=['admin', 'profesor'].
- **medium · authorization_mismatch**: Permisos observables distintos para GET:/materias/{}/dba: backend=['authenticated'], frontend=['admin', 'profesor'].
- **medium · authorization_mismatch**: Permisos observables distintos para GET:/materias/{}/asistencia: backend=['authenticated'], frontend=['admin', 'profesor'].

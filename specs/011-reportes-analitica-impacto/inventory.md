...
| frontend_route | `/app/analytics` | admin, profesor | covered | `frontend/src/config/routes.ts:58` |
| frontend_route | `/app/reportes` | admin, profesor | covered | `frontend/src/config/routes.ts:54` |

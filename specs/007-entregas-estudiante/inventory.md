...
|---|---|---|---|---|
| endpoint | `GET:/calificaciones/entregas/{entrega_id}/evidencia` | admin, estudiante, profesor | covered | `backend/app/modules/calificaciones/router.py:1345` |
| endpoint | `GET:/calificaciones/entregas/{entrega_id}/evidencia/paginas/{numero}` | admin, estudiante, profesor | covered | `backend/app/modules/calificaciones/router.py:1390` |

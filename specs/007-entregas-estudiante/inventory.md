...
|---|---|---|---|---|
| endpoint | `GET:/calificaciones/entregas/{entrega_id}/evidencia` | admin, estudiante, profesor | covered | `backend/app/modules/calificaciones/router.py:1411` |
| endpoint | `GET:/calificaciones/entregas/{entrega_id}/evidencia/paginas/{numero}` | admin, estudiante, profesor | covered | `backend/app/modules/calificaciones/router.py:1456` |
...
| endpoint | `POST:/evaluaciones/{evaluacion_id}/entregas` | admin, estudiante | covered | `backend/app/modules/calificaciones/router.py:1182` |
| endpoint | `POST:/evaluaciones/{evaluacion_id}/entregas/archivo` | admin, estudiante | covered | `backend/app/modules/calificaciones/router.py:1277` |

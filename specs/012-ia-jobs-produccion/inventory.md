...
| job | `tasks.digitalize_evaluation` | system | missing | `backend/app/workers/tasks_digitalization.py:249` |
...
| job | `tasks.grade_batch` | system | missing | `backend/app/workers/tasks_grading.py:612` |

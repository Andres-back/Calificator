...
|---|---|---|---|---|
| endpoint | `GET:/jobs/{job_id}` | authenticated | covered | `backend/app/modules/jobs/router.py:40` |
| endpoint | `GET:/jobs/{job_id}/estado` | authenticated | missing | `backend/app/modules/jobs/router.py:87` |
| endpoint | `GET:/jobs/{job_id}/items` | authenticated | missing | `backend/app/modules/jobs/router.py:97` |
| endpoint | `POST:/jobs/{job_id}/cancelar` | authenticated | missing | `backend/app/modules/jobs/router.py:279` |
| endpoint | `POST:/jobs/{job_id}/reintentar` | authenticated | missing | `backend/app/modules/jobs/router.py:148` |
| frontend_call | `GET:/jobs/{jobId}` | ambiguous | covered | `frontend/src/modules/calificaciones/gradingJobs.ts:110` |
...
| job | `tasks.grade_batch` | system | covered | `backend/app/workers/tasks_grading.py:767` |
| job | `tasks.grade_delivery` | system | covered | `backend/app/workers/tasks_grading.py:821` |
...
| job | `tasks.recover_stale_grading_jobs` | system | covered | `backend/app/workers/tasks_grading.py:928` |

...
| frontend_route | `/app/materias` | estudiante | covered | `frontend/src/config/routes.ts:21` |
| frontend_route | `/app/materias/{id}` | admin, profesor | covered | `frontend/src/config/routes.ts:25` |

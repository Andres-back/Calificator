# Especificación: Presentaciones e imágenes

**Rama**: codex/010-presentaciones-imagenes | **Creada**: 2026-08-14 | **Estado**: Aprobada | **Issue**: #11

## Escenarios de usuario y pruebas

### Historia 1 - Flujo principal (Prioridad: P1)
Como profesor, necesito generar, previsualizar y exportar presentaciones visuales coherentes para obtener un resultado claro, seguro y trazable.
...
### Casos límite
- PDF y PPTX deben representar el mismo contenido y una descarga móvil no bloquea la navegación
...
- **FR-003**: Se DEBEN conservar estas entidades: Presentacion, PresentacionEstado, ImagenGenerada, Slide, Asset.
...
- **PresentacionEstado**: identidad, estado y relaciones definidos por el dominio.
- **ImagenGenerada**: identidad, estado y relaciones definidos por el dominio.
- **Slide**: identidad, estado y relaciones definidos por el dominio.
- **Asset**: identidad, estado y relaciones definidos por el dominio.

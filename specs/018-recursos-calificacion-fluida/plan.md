...
10. La rúbrica generada es un borrador controlado por el cliente antes de confirmar. Se normaliza sin perder metadatos, permite editar criterios, pesos y descriptores, y usa el PATCH vigente; no requiere migración ni contrato nuevo. El avance se bloquea hasta totalizar 100 % y el puntaje máximo de cada criterio se recalcula al guardar.

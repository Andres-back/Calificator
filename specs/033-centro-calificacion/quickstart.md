...
- CI técnico 34487222779 sobre 77c9422: backend, frontend (incluidos los 59 E2E) y contenedores aprobados. La gobernanza bloqueaba exclusivamente las tareas de cierre todavía abiertas; se completan ahora con evidencia, sin modificar su validador.
- Última revisión de convergencia: 16 requisitos funcionales, ocho criterios de éxito, 19 escenarios de aceptación, siete decisiones del plan y ocho principios de constitución contrastados. Se añadieron T027/T028 al detectar resumen final oculto en móvil y falta de invalidación/versionado inicial del ajuste global. Corregidas ambas; no quedan brechas funcionales detectadas en el alcance.
- Suite E2E local completa: 59/59 aprobadas en 4,9 minutos, incluida la comprobación del resumen final a 390 px. Nueva regresión adicional de ajuste global: aprobada (conflicto 409 conserva borrador, envío de versión inicial, refresco de listado tras persistencia). La suite pasa a tener 60 casos. TypeScript y lint del componente modificados: aprobados.
- Inventario técnico sin diferencias; propietarios actualizados. Los fallos previos y sus repeticiones quedan arriba para trazabilidad, no son el estado final. No se modificaron fórmulas, proveedores, credenciales ni datos estudiantiles.
- 28 tareas completadas. El commit de cierre debe pasar de nuevo todos los checks del PR #69 antes del merge protegido a main. El cierre de tareas no equivale a afirmar un despliegue: se verificará la versión servida después de fusionar.
